...
var extractPNGFromSourceVideo = function(sourcePathname, destPath, filePattern) {
    var d = Q.defer();
    ffmpegCommand()
...
var combinePNGToNewVideo = function(metadata, encoderSettings, sourcePathname, framesPathname, destPathname) {
    var d = Q.defer();

    var videoSettings = [
        '-map 0:v',
        printf('%s %s', '-vcodec', encoderSettings.encoderLib)
    ];
    encoderSettings.encodingOptions[encoderSettings.encoderLib].forEach(function(arg) {
